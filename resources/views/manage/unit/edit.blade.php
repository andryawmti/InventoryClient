    ...
    <div class="content-wrapper">
        <div class="content-heading">
            <div>
                ...
                <ol class="breadcrumb breadcrumb px-0 pb-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('unit.index') }}">Unit</a>
                    </li>
        ...
        <div class="container-fluid">
            ...
            <div class="card card-default" role="tabpanel">
                <div class="card-header"><h4>Edit Unit</h4></div>
                <div class="card-body">
                    <form class="form-horizontal" method="post" action="{{route('unit.update', ['id' => $unit->id])}}">
                        @csrf
                        ...
                        <fieldset>
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" value="{{ $unit->name }}" name="name" required>
                                </div>
                            </div>
                        </fieldset>
                        <fieldset>
