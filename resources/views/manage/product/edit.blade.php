                    ...
                    <form class="form-horizontal" method="post" action="{{route('product.update', ['id' => $product->id])}}">
                                ...
                                <div class="col-md-10">
                                    <select class="form-control" name="product_category_id" required>
                                        @foreach($product_categories as $pc)
                                            <option @if($product->product_category_id == $pc->id) selected @endif value="{{ $pc->id }}">{{ $pc->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <select class="form-control" name="unit_id" required>
                                        @foreach($units as $u)
                                            <option @if($product->unit_id == $u->id) selected @endif value="{{ $u->id }}">{{ $u->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <fieldset>
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" value="{{ $product->buy_price }}" name="buy_price" required>
                                </div>
                            </div>
                        </fieldset>
                        <fieldset>
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" value="{{ $product->sell_price }}" name="sell_price" required>
                                </div>
                            </div>
                        </fieldset>
                        <fieldset>
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" value="{{ $product->stock }}" name="stock" required>
                                </div>
                            </div>
                        </fieldset>
                        <fieldset>
