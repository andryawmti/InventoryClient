    ...
    <div class="content-wrapper">
        <div class="content-heading">
            <div>
                ...
                <ol class="breadcrumb breadcrumb px-0 pb-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('product-category.index') }}">Product Category</a>
                    </li>
        ...
        <div class="container-fluid">
            ...
            <div class="card card-default" role="tabpanel">
                <div class="card-header"><h4>Edit Product Category</h4></div>
                <div class="card-body">
                    <form class="form-horizontal" method="post" action="{{route('product-category.update', ['id' => $product_category->id])}}">
                        @csrf
                        ...
                        <fieldset>
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <textarea class="form-control" name="description">{{ $product_category->description }}</textarea>
                                </div>
                            </div>
                        </fieldset>
                        <fieldset>
