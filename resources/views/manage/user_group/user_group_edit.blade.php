    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="card card-default" role="tabpanel">
                <div class="card-header"><h4>Edit User Group</h4></div>
                <div class="card-body">
                    <form class="form-horizontal" method="post" action="{{route('user-group.update', ['id' => $user_group->id])}}">
                        @csrf
                        ...
                        <fieldset>
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control" name="name" type="text" value="{{$user_group->name}}" required>
                                </div>
                            </div>
                        </fieldset>
                        <fieldset>
